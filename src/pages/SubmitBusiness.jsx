          ...
          <Section title="SECTION 1 — Business Info">
            ...
            <SubSection>
              <Field label="Product/Services Details *">
                <p className="text-sm text-muted-foreground mb-2 leading-relaxed">
                  A brief description of the products you're selling and or the services you're rendering. This will be shown while customers are browsing all the listings.
                  <br /><br />
              ...
              <Field label="Upload Product/Services Photos (optional)">
                <p className="text-sm text-muted-foreground mb-2 leading-relaxed">
                  Image of the products you're selling and or the services you're rendering. Example can be from your social media posts.
                  <br /><br />
                  <strong>PLEASE TAKE NOTE:</strong> Only FIVE photos can be uploaded. Remember to choose the nicest photo of your products/services you have. 🙂
                </p>
                <label className="flex flex-col items-center gap-2 border-2 border-dashed border-border rounded-xl p-6 cursor-pointer hover:border-primary/50 transition-colors">
                  <Upload className="w-8 h-8 text-muted-foreground" />
              ...
              <Field label="Location *">
                <p className="text-sm text-muted-foreground mb-2 leading-relaxed">
                  ...
                  <br /><br />
                  Example: If your postal code is 189165, your first two digits are 18, so choose "07 [Central] Middle Road, Golden Mile [18, 19]"
                </p>
