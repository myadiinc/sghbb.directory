      ...
      <div className="bg-secondary/40 border-t border-border px-4 py-10">
        <div className="max-w-2xl mx-auto space-y-8">
          ...
          <div className="text-center">
            <h3 className="font-quicksand font-bold text-primary text-base mb-3">About This Directory</h3>
          ...
          {/* Support */}
          <div className="text-center">
            <h3 className="font-quicksand font-bold text-primary text-base mb-3">Support the Directory</h3>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              <div className="flex flex-col items-center gap-2">
                <p className="text-xs font-semibold text-foreground uppercase tracking-wide">PayNow</p>
                <a href="https://i.ibb.co/s9wzmDN2/Pay-Now-Support-SGHBBDirectory-V1-0.jpg" target="_blank" rel="noopener noreferrer">
                  <img
